...
Git + GitHub
安装与运行
1.克隆仓库：前端：https://github.com/3528706162-arch/EduShare-QA
后端：https://github.com/3528706162-arch/EduShare-QA-Backend

2.后端配置：修改application.yml数据库信息及阿里云 OSS 配置，mvn clean package && java -jar target/edushare-qa-0.0.1-SNAPSHOT.jar
3.前端配置：进入前端目录执行npm install，运行npm run dev
4.访问地址：前端http://localhost:5173，后端http://localhost:8080
初始账号
